...
for val in stocks:
    ...
    if not os.path.exists("Graphs_Stack_Model"):
          os.mkdir("Graphs_Stack_Model")
  
    plt.savefig("Graphs_Stack_Model/"+val+' Dataset'+'.png')
    plt.cla()
    # plt.show()
    ...
    hist=model.fit(X_train,y_train,validation_data=(X_test,ytest),epochs=2,batch_size=16,verbose=1)
    print(hist.history)
    model.save("saved_model/"+val+"/my_model.h5")
    # model = keras.models.load_model("saved_model/"+val+"/my_model.h5")
    ...
    plt.savefig("Graphs_Stack_Model/"+val+' train_test'+'.png')
    plt.cla()
    # plt.show()
    ...
    plt.savefig("Graphs_Stack_Model/"+val+' test'+'.png')
    plt.cla()
    # plt.show()
    ...
    plt.savefig("Graphs_Stack_Model/"+val+' loss'+'.png')
    plt.show()
